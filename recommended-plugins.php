...
if ( $data && ! is_wp_error( $data ) ) {
	$recommended_plugins['wp-force-logout']       = $data;
	$recommended_plugins['wp-force-logout']->name = 'WPForce Logout';
}


/* Internet Connection Alert! Plugin */
$args = array(
	'slug'   => 'internet-connection-status',
	'fields' => array(
		'short_description' => true,
		'icons'             => true,
		'reviews'           => false, // excludes all reviews
...
$data = plugins_api( 'plugin_information', $args );
if ( $data && ! is_wp_error( $data ) ) {
	$recommended_plugins['internet-connection-status']       = $data;
	$recommended_plugins['internet-connection-status']->name = 'Internet Connection Alert!';
}
