...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__create_i18n__ = __webpack_require__(3);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__placeholder__ = __webpack_require__(32);
...
registerBlockType('wp-frontend-delete-account/delete-account-content', {
    title: Object(__WEBPACK_IMPORTED_MODULE_0__wordpress_i18n__["a" /* __ */])('WP Frontend Account Delete', 'wp-frontend-delete-account'),
    icon: 'admin-users',
    category: 'common',
    attributes: {
        images: {
    ...
    edit: __WEBPACK_IMPORTED_MODULE_1__placeholder__["a" /* default */],

    /**
     * Save()
     */
    Placeholder: __WEBPACK_IMPORTED_MODULE_1__placeholder__["a" /* default */]
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__create_i18n__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__wordpress_hooks__ = __webpack_require__(17);
/**
...
var i18n = Object(__WEBPACK_IMPORTED_MODULE_0__create_i18n__["a" /* createI18n */])(undefined, undefined, __WEBPACK_IMPORTED_MODULE_1__wordpress_hooks__["a" /* defaultHooks */]);
/**
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return defaultHooks; });
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__validateNamespace_js__ = __webpack_require__(4);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__arrayLikeToArray_js__ = __webpack_require__(5);
...
function Placeholder() {
	...
	if (wpfda_plugins_params.is_administrator) {
		element = [wp.element.createElement(
			'i',
			{ key: 'warning', style: { color: 'red' } },
			' ',
			Object(__WEBPACK_IMPORTED_MODULE_0__wordpress_i18n__["a" /* __ */])('Just a heads up! You are the site administrator and processing further will delete yourself.', 'wp-frontend-delete-account'),
			' '
		)];
	}

	if ('password' === wpfda_plugins_params.security) {
		element = [].concat(_toConsumableArray(element), [wp.element.createElement(
			'div',
			{ key: 'wpfda-password-confirm', className: 'wpfda-password-confirm' },
			wp.element.createElement(
				'label',
				null,
				' ',
				wpfda_plugins_params.password_text,
				' '
			),
			wp.element.createElement('input', { type: 'password', name: 'wpfda-password' })
		)]);
	}
	...
	if ('custom_captcha' === wpfda_plugins_params.security && '' !== wpfda_plugins_params.captcha_question) {
		element = [].concat(_toConsumableArray(element), [wp.element.createElement(
			'div',
			{ key: 'wpfda-custom-captcha', className: 'wpfda-custom-captcha' },
			wp.element.createElement(
				'label',
				null,
				' ',
				wpfda_plugins_params.captcha_question,
				' '
			),
			wp.element.createElement('input', { type: 'text', name: 'wpfda-custom-captcha-answer' })
		)]);
	}

	element = [].concat(_toConsumableArray(element), [wp.element.createElement(
		'div',
		{ key: 'wpfda-submit', className: 'wpfda-submit' },
		wp.element.createElement(
			'button',
			{ type: 'submit' },
			wpfda_plugins_params.button
		)
	)]);
